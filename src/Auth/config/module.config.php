...
return [
    ...
    'dependencies' => [
        ...
        'factories'  => [
            ...
            \Zend\Authentication\AuthenticationServiceInterface::class => \Auth\AuthenticationServiceFactory::class,
            \Auth\Action\Login::class => \Auth\Action\LoginFactory::class,
            \Auth\Action\RouteLock::class => \Auth\Action\RouteLockFactory::class,
